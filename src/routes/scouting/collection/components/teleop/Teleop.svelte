...
<div class="flex m-4">
    <span class="flex flex-col justify-center text-w scale-text font-semibold center">Amp Scored</span>
...
<div class="rounded flex justify-between text-w m-4">
    <span class="flex flex-col justify-center text-w scale-text font-semibold center">Speaker Scored</span>
